...
declare module "@salesforce/schema/Product2.Initial_Inventory__c" {
  const Initial_Inventory__c:number;
  export default Initial_Inventory__c;
}
declare module "@salesforce/schema/Product2.Quantity_Ordered__c" {
  const Quantity_Ordered__c:number;
  export default Quantity_Ordered__c;
}
declare module "@salesforce/schema/Product2.Quantity_Remaining__c" {
  const Quantity_Remaining__c:number;
  export default Quantity_Remaining__c;
}
